...
func TestInventoryLevelsList(t *testing.T) {
	...
	levels, err := client.InventoryLevel.ListInventoryLevel(nil)
	if err != nil {
...
func TestInventoryLevelListWithItemId(t *testing.T) {
	...
	levels, err := client.InventoryLevel.ListInventoryLevel(options)
	if err != nil {
		t.Errorf("InventoryLevels.List returned error: %v", err)
	}
...
func TestInventoryLevelAdjust(t *testing.T) {
	...
	adjItem, err := client.InventoryLevel.AdjustInventoryLevel(option)
	if err != nil {
...
func TestInventoryLevelDelete(t *testing.T) {
	...
	err := client.InventoryLevel.DeleteInventoryLevel(1, 1)
	if err != nil {
...
func TestInventoryLevelConnect(t *testing.T) {
	...
	level, err := client.InventoryLevel.ConnectInventoryLevel(options)
	if err != nil {
...
func TestInventoryLevelSet(t *testing.T) {
	...
	level, err := client.InventoryLevel.SetInventoryLevel(options)
	if err != nil {
