...
func TestCustomCollectionList(t *testing.T) {
	...
	products, err := client.CustomCollection.ListCustomCollection(nil)
	if err != nil {
...
func TestCustomCollectionCount(t *testing.T) {
	...
	cnt, err := client.CustomCollection.CountCustomCollection(nil)
	if err != nil {
	...
	cnt, err = client.CustomCollection.CountCustomCollection(CountOptions{CreatedAtMin: date})
	if err != nil {
		t.Errorf("CustomCollection.Count returned error: %v", err)
	}
...
func TestCustomCollectionGet(t *testing.T) {
	...
	product, err := client.CustomCollection.GetCustomCollection(1, nil)
	if err != nil {
...
func TestCustomCollectionCreate(t *testing.T) {
	...
	returnedCollection, err := client.CustomCollection.CreateCustomCollection(collection)
	if err != nil {
...
func TestCustomCollectionUpdate(t *testing.T) {
	...
	returnedCollection, err := client.CustomCollection.UpdateCustomCollection(collection)
	if err != nil {
...
func TestCustomCollectionDelete(t *testing.T) {
	...
	err := client.CustomCollection.DeleteCustomCollection(1)
	if err != nil {
