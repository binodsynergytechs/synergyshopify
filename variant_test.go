...
func TestVariantList(t *testing.T) {
	...
	variants, err := client.Variant.ListVariant(1, nil)
	if err != nil {
...
func TestVariantGet(t *testing.T) {
	...
	variant, err := client.Variant.GetVariant(1, nil)
	if err != nil {
...
func TestVariantCreate(t *testing.T) {
	...
	result, err := client.Variant.CreateVariant(1, variant)
	if err != nil {
...
func TestVariantUpdate(t *testing.T) {
	...
	returnedVariant, err := client.Variant.UpdateVariant(variant)
	if err != nil {
...
func TestVariantDelete(t *testing.T) {
	...
	err := client.Variant.DeleteVariant(1, 1)
	if err != nil {
...
func TestVariantListMetaFields(t *testing.T) {
	...
	metafields, err := client.Variant.ListVariantMetaFields(1, nil)
	if err != nil {
...
func TestVariantCountMetafields(t *testing.T) {
	...
	cnt, err := client.Variant.CountVariantMetaFields(1, nil)
	if err != nil {
	...
	date := time.Date(2016, time.January, 1, 0, 0, 0, 0, time.UTC)
	cnt, err = client.Variant.CountVariantMetaFields(1, CountOptions{CreatedAtMin: date})
	if err != nil {
		t.Errorf("Variant.CountMetafields() returned error: %v", err)
	}
...
func TestVariantGetMetafield(t *testing.T) {
	...
	metafield, err := client.Variant.GetVariantMetaField(1, 2, nil)
	if err != nil {
...
func TestVariantCreateMetafield(t *testing.T) {
	...
	returnedMetafield, err := client.Variant.CreateVariantMetaField(1, metafield)
	if err != nil {
...
func TestVariantUpdateMetafield(t *testing.T) {
	...
	returnedMetafield, err := client.Variant.UpdateVariantMetaField(1, metafield)
	if err != nil {
...
func TestVariantDeleteMetafield(t *testing.T) {
	...
	err := client.Variant.DeleteVariantMetaField(1, 2)
	if err != nil {
