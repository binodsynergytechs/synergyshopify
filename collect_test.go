...
func TestCollectList(t *testing.T) {
	...
	collects, err := client.Collect.ListCollect(nil)
	if err != nil {
...
func TestCollectCount(t *testing.T) {
	...
	cnt, err := client.Collect.CountCollect(nil)
	if err != nil {
	...
	cnt, err = client.Collect.CountCollect(ListOptions{SinceID: 123})
	if err != nil {
		t.Errorf("Collect.Count returned error: %v", err)
	}
...
func TestCollectGet(t *testing.T) {
	...
	product, err := client.Collect.GetCollect(1, nil)
	if err != nil {
...
func TestCollectCreate(t *testing.T) {
	...
	returnedCollect, err := client.Collect.CreateCollect(collect)
	if err != nil {
...
func TestCollectDelete(t *testing.T) {
	...
	err := client.Collect.DeleteCollect(1)
	if err != nil {
