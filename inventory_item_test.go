...
func TestInventoryItemsList(t *testing.T) {
	...
	items, err := client.InventoryItem.ListInventoryItem(nil)
	if err != nil {
...
func TestInventoryItemsListWithIDs(t *testing.T) {
	...
	items, err := client.InventoryItem.ListInventoryItem(options)
	if err != nil {
		t.Errorf("InventoryItems.List returned error: %v", err)
	}
...
func TestInventoryItemGet(t *testing.T) {
	...
	item, err := client.InventoryItem.GetInventoryItem(1, nil)
	if err != nil {
...
func TestInventoryItemUpdate(t *testing.T) {
	...
	updatedItem, err := client.InventoryItem.UpdateInventoryItem(item)
	if err != nil {
