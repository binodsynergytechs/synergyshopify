...
func TestAssetList(t *testing.T) {
	...
	assets, err := client.Asset.ListAsset(1, nil)
	if err != nil {
...
func TestAssetGet(t *testing.T) {
	...
	asset, err := client.Asset.GetAsset(1, "foo/bar.liquid")
	if err != nil {
...
func TestAssetUpdate(t *testing.T) {
	...
	returnedAsset, err := client.Asset.UpdateAsset(1, asset)
	if err != nil {
...
func TestAssetDelete(t *testing.T) {
	...
	err := client.Asset.DeleteAsset(1, "foo/bar.liquid")
	if err != nil {
