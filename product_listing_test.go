...
func productListingTests(t *testing.T, product ProductListing) {
	...
	if product.ProductID != expectedInt {
		t.Errorf("Product.ProductID returned %+v, expected %+v", product.ProductID, expectedInt)
	}
}
...
func TestProductListingList(t *testing.T) {
	...
	products, err := client.ProductListing.ListProductListing(nil)
	if err != nil {
...
func TestProductListingListWithPagination(t *testing.T) {
	...
	cases := []struct {
		...
		// Expect empty pagination when there is no link header
		{
			...
			"",
			[]ProductListing{{ProductID: 1}, {ProductID: 2}},
			new(Pagination),
			nil,
		},
	...
	for i, c := range cases {
		...
		products, pagination, err := client.ProductListing.ListWithPaginationProductListing(nil)
...
func TestProductListingsCount(t *testing.T) {
	...
	cnt, err := client.ProductListing.CountProductListing(nil)
	if err != nil {
	...
	cnt, err = client.ProductListing.CountProductListing(CountOptions{CreatedAtMin: date})
	if err != nil {
		t.Errorf("Product.Count returned error: %v", err)
	}
...
func TestProductListingGet(t *testing.T) {
	...
	product, err := client.ProductListing.GetProductListing(1, nil)
	if err != nil {
...
func TestProductListingGetProductIDs(t *testing.T) {
	...
	productIDs, err := client.ProductListing.GetProductIDsProductListing(nil)
	if err != nil {
		t.Errorf("ProductListing.Get returned error: %v", err)
	}
...
func TestProductListingPublish(t *testing.T) {
	...
	returnedProduct, err := client.ProductListing.PublishProductListing(product.ID)
	if err != nil {
...
func TestProductListingDelete(t *testing.T) {
	...
	err := client.ProductListing.DeleteProductListing(1)
	if err != nil {
